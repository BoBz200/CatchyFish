...
public:
  ...
  static void draw(std::vector<std::string>& text, int height, int width, int start_y, int start_x, bool is_boxed, int color);
  static void draw(std::vector<std::string>& text, int height, int width, int start_y, int start_x, int color);
  static void draw(std::vector<std::string>& text, int height, int width, int start_y, int start_x);
  static void draw(std::vector<std::string>& text, int start_y, int start_x, int color);
  static void draw(std::vector<std::string>& text, int start_y, int start_x);
